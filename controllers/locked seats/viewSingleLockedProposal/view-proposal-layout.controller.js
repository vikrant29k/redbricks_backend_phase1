...
const viewLayoutOfOneProposal = (req, res, next) => {
    ...
    Proposal.findById(Id).then((proposal) => {
        ...
        if (!proposal) {
            ...
            const selectionDataId = proposal.selectionData.toString();
          console.log(selectionDataId)

        selectionData.findById(selectionDataId).then(layouDataFromjson=>{
...
module.exports = viewLayoutOfOneProposal;